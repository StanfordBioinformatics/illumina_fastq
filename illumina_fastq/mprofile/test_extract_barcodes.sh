...
module load gbsc/illumina_fastq/current
...
mprof run extract_barcodes.py --r1 r1.fastq --r2=r2.fastq -b ATTCCT --outfile-prefix=extracted_barcode --outdir=Extracted
